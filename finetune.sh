#!/bin/bash
#SBATCH --job-name=PolyDiff_Finetune
#SBATCH --account=mse
#SBATCH --qos=coe-ice
#SBATCH --nodes=1 
...
echo "Fine-tuning with property conditioning (Egc - band gap)"
echo ""
...
echo ""
echo "Fine-tuning finished with exit code: $EXIT_CODE | End: $(date)"
